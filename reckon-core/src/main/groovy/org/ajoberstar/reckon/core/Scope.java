...
public enum Scope {
  ...
  /**
   * A versioner that will increment the component of the previous release corresponding with the
   * name of the enum value. (e.g. MAJOR would increment 1.2.3 to 2.0.0). If the previous version
   * has the same normal component as the currently incremented one, it's pre-release information
   * will be preserved.
   *
