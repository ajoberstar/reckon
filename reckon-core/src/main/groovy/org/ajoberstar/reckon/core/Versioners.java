...
public final class Versioners {
    ...
    /**
     * Parses the given version and creates a versioner that will
     * always return it.
    ...
    /**
     * @return a versioner that will return the current version from the VCS or
     * throw an exception if one is not available
     */
    ...
    /**
     * Creates a versioner that will use the given scope and stage
     ...
     * @param enforcePrecedence whether or not to enforce that the inferred
     *                          version is greater than or equal to the previous
